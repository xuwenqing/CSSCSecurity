...
Entities.Accident = (function (Backbone, Entities, _) {
    ...
    var API_SAVE = base + '/accident/add';//��Ӱ�ȫְҵ����
    var API_EDIT = base + '/accident/edit';//�༭��ȫְҵ����
    var API_QUERY = base + '/accident/queryDetail';//��ѯָ��id����
    var API_FETCH = base + '/accident/query';//��ѯ��ȫְҵ����
    var API_DESTROY = base + '/accident/delete';//ɾ��ȫְҵ����
    var API_DELETES = base + '/accident/deletes';//ɾ��ȫְҵ����
