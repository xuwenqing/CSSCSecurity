...
Entities.Frock = (function (Backbone, Entities, _) {
    ...
    var API_QUERY = base + '/frock/queryDetail';//查询指定id内容
    var API_FETCH = base + '/frock/query';//查询安全职业健康
    var API_DESTROY = base + '/frock/delete';//删除安全职业健康
    var API_DELETES = base + '/frock/deletes';//删除安全职业健康
